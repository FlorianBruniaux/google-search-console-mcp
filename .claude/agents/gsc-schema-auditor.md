...
tools:
  ...
  - mcp__gsc-mcp__schema_validate
model: sonnet
---

Load the `schema-audit` skill and follow it exactly. Your final answer is the issues table and prioritized fixes, not a description of what you did.
