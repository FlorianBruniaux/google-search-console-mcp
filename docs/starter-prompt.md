...
10. Sitemap health: list all submitted sitemaps, flag errors or warnings,
    and note the last download date.
...
14. Produce a prioritized action plan:
    - Critical (fix this week): indexing blocks, high-severity alerts
    - High (fix this month): quick wins, cannibalization, lost queries
    - Medium (next quarter): striking distance pages, GA4 engagement gaps
